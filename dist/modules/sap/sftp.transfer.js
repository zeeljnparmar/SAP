...
const config = {
    host: constants_1.STARQUIK_SFTP_HOST,
    port: 22,
    username: constants_1.STARQUIK_SFTP_USERNAME,
    password: constants_1.STARQUIK_SFTP_PASSWORD
};
let SAPService = class SAPService {
    ...
    commonService;
    constructor(pdmDataSource, pdmReaderDataSource, productPricingService, businessDataModelService, commonService) {
    ...
    async removeStaticMrpInconsistencies(metaData) {
    ...
    async getProductFilesFromSftp(metaData, jobId) {
        try {
    ...
    async getSapFilesFromSftp(metaData, jobId) {
        try {
    ...
    async removeSapStoreStatusInconsistencies(metaData) {
...
exports.SAPService = SAPService = __decorate([
    ...
    __metadata("design:paramtypes", [typeorm_2.DataSource,
        ...
        pim_update_1.PimUploadService,
        business_data_model_service_1.BusinessDataModelService,
        common_service_1.CommonService])
], SAPService);
//# sourceMappingURL=sftp.transfer.js.map