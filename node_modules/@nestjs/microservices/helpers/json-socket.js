...
const max_packet_length_exceeded_exception_1 = require("../errors/max-packet-length-exceeded.exception");
    ...
    handleData(dataRaw) {
        ...
        while (true) {
            if (this.buffer.length > this.maxBufferSize) {
                ...
                this.buffer = '';
                throw new max_packet_length_exceeded_exception_1.MaxPacketLengthExceededException(bufferLength);
            }
