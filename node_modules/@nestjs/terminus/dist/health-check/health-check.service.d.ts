...
export declare class HealthCheckService {
     ...
     */
    check<const TFns extends HealthIndicatorFunction[]>(healthIndicators: TFns): Promise<import("./health-check-result.interface").HealthCheckResult<import("../health-indicator").InferHealthIndicatorResults<TFns, []>>>;
}
