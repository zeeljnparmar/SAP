 ...
 * @publicApi
 */
export type HealthCheckResult<TDetails extends HealthIndicatorResult = HealthIndicatorResult, TInfo extends Partial<HealthIndicatorResult> | undefined = Partial<TDetails> | undefined, TError extends Partial<HealthIndicatorResult> | undefined = Partial<TDetails> | undefined> = {
    /**
