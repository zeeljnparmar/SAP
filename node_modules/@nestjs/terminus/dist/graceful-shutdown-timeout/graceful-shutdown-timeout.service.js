...
let GracefulShutdownService = GracefulShutdownService_1 = class GracefulShutdownService {
    ...
    get isEnabled() {
        var _a;
        return ((_a = this.options.gracefulShutdownTimeoutMs) !== null && _a !== void 0 ? _a : 0) > 0;
    }
    beforeApplicationShutdown(signal) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (signal === 'SIGTERM') {
                this.logger.log(`Awaiting ${this.options.gracefulShutdownTimeoutMs}ms before shutdown`);
                yield (0, utils_1.sleep)(this.options.gracefulShutdownTimeoutMs);
...
exports.GracefulShutdownService = GracefulShutdownService = GracefulShutdownService_1 = __decorate([
    ...
    __param(0, (0, common_1.Inject)(terminus_constants_1.TERMINUS_LOGGER)),
    __param(1, (0, common_1.Inject)(terminus_constants_1.TERMINUS_MODULE_OPTIONS)),
